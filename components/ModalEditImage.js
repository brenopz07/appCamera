...
export default function ModalEditImage({ image, visible, onClose, imageMirror }) {
    ...
    const angle = useAnimatedStyle(0);
    
    const rotation = Gesture.Rotation().onStart(() =>{
              ...
              <SafeAreaView style={styles.container}>
                ...
                <View style={styles.imageArea}>
                  ...
                  <Animated.Image 
                   ...
                   style={[
                    {
                        width: (image.width * height) / image.height, height: height, transform: [{scaleX:imageMirror}] 
                    },
                    imageAnimatedStyles,
                    ]}
                 />
      ...
      {/* BOTÕES */}
        <View style={styles.buttonContainerModal}>
            ...
            <View style={styles.buttonContainerModal2}>
                ...
                <TouchableOpacity style={styles.buttonModal} onPress={() => setModalSticker(true)}>
